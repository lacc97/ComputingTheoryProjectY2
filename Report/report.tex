...
\begin{document}
    ...
    \section{Results and discussion}
        \subsection{Comparison between Fermi gas model and nucleon interaction model}
            ...
            \hline
            $K_0(MeV)$ & 100 & 175 & 250 & 325& 400 \\ 
            \hline
            Maximum Mass ($M_{\odot}$) & 1.36 & 2.01 & 2.30 & 2.27 & 1.97 \\ 
            \hline
            \end{tabular}
            \caption{Maximum masses of neutron stars for a given nuclear incompressibility $K_0$}\label{tab/max_mass}
            \end{center}
            \end{table}

            
            The calculated maximum mass of the neutron stars for the nucleon interaction EOS are listed in the Table \ref{tab/max_mass}.
